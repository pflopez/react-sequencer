...
export default function Track(
    {trackModel, onUpdateTrack, activeStep, adding, setAdding, clickStepTarget, setClickStepTarget}: Props) {
            ...
            <div className={styles.trackSteps}>
                {trackModel.steps.map((step) => (
                    <div key={step.id}
                         ...
                         className={styles.step + ' ' + (step.on ? styles.active : ' ' ) +  ' ' + (step.accent ? styles.accent : '')}
